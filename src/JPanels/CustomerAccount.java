...
public class CustomerAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        accsus.add(suspend, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 0, -1, 30));

        jLabel8.setBackground(new java.awt.Color(59, 63, 66));
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Task List ");
        accsus.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 30));
    ...
    public void initiateData(String s){
        ...
        try{
            ...
            while(rs.next()){
                ...
                cno.setText(String.valueOf(rs.getInt("contact_no")));
