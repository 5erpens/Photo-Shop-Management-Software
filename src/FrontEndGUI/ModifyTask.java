...
public class ModifyTask extends javax.swing.JFrame {
    ...
    public ModifyTask(Connection conn, JFrame frame, ArrayList<String> l) {
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        address.setText("Do you want to delete or modify this account? ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new MySQLQueries(conn).DeleteTask(l);
        frame.enable();
        frame.intake();
        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new EditTask(conn,frame,l).show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifyTask(conn, new JFrame(), new ArrayList<>()).setVisible(true);
            }
        });
    }
