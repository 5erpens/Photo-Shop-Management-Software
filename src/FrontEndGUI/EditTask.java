...
public class EditTask extends javax.swing.JFrame {
    ...
    private ArrayList<String> ls,l;

    int mouseX;
    int mouseY;

    public EditTask(Connection conn, JFrame frame, ArrayList<String> l) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modify New Tasks");
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 280, 140, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new MySQLQueries(conn).ModifyTable(ls,l);
        frame.enable(true);
        frame.intake();
        this.dispose();
    ...
    public void resetTabs(){
        dis.setText(l.get(0));
        area.setSelectedItem(l.get(1));
        ss.setText(l.get(2));
        price.setText(l.get(3));
        time.setText(l.get(4));
        discount.setText(l.get(5));
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditTask(conn, new JFrame(), new ArrayList<String>()).setVisible(true);
            }
        });
    }
