...
public class CreateJob extends javax.swing.JFrame {
    ...
    private void Submit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Submit1ActionPerformed
        if (type.equals("Valued")) {
            ...
            ArrayList<String> ls = new MySQLQueries(conn).discount(String.valueOf(cid));
            if (ls.get(0).equals("Fixed")) {
                
                for (int i = 0; i < table.getModel().getRowCount(); i++) {
                    
                    fl.add(ls.get(1));
                    table.getModel().setValueAt(new CodeSet().Discount(Float.parseFloat(table.getModel().getValueAt(i, 2).toString()), Float.valueOf(ls.get(1))), i, 2);
                    
                }
            } else if (ls.get(0).equals("Flexible")) {
                
                float f = new MySQLQueries(conn).FlexibleDiscount(String.valueOf(cid));
                
                
                for (int i = 0; i < table.getModel().getRowCount(); i++) {
                    
                    fl.add(String.valueOf(f));
                    table.getModel().setValueAt(new CodeSet().Discount(Float.parseFloat(table.getModel().getValueAt(i, 2).toString()), f), i, 2);
                ...
                for (int i = 0; i < table.getModel().getRowCount(); i++) {
                    ...
                    f = new MySQLQueries(conn).VariabeDiscount(table.getValueAt(i, 0).toString());
                    fl.add(String.valueOf(f));
                    table.getModel().setValueAt(new CodeSet().Discount(Float.parseFloat(table.getModel().getValueAt(i, 2).toString()), f), i, 2);
                }
