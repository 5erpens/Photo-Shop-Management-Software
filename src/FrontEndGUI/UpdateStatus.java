...
public class UpdateStatus extends javax.swing.JFrame {
    ...
    public UpdateStatus(Connection conn, JFrame frame, String sid) {
        this.frame = frame;
        this.conn = conn;
        this.setUndecorated(true);
        initComponents();
        table.setModel(new MySQLQueries(conn).passwordUpdate());
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Password Reset Request");
        jPanel9.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 460, -1));
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        new resetPass(conn, table.getValueAt(table.getSelectedRow(), 0).toString(), this).show();
        this.disable();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateStatus(conn, new JFrame(), new String()).setVisible(true);
            }
        });
    }
