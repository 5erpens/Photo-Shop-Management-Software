...
public class OCustomerAccount extends javax.swing.JFrame {
    ...
    int mouseX;
    int mouseY;
    public OCustomerAccount(Connection conn, String s, JFrame frame) {
        this.s=s;
        this.frame = frame;
        this.conn = conn;
    ...
    private void addTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTaskActionPerformed
        ...
        new CreateJob(conn,id.getText(),cid,false,frame,s).show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OCustomerAccount(conn,s,new JFrame()).setVisible(true);
            }
        });
