...
public class OCustomerAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        discount.setBackground(new java.awt.Color(153, 153, 153));
        discount.setForeground(new java.awt.Color(59, 63, 66));
        discount.setToolTipText("");
        discount.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        dis.setBackground(new java.awt.Color(59, 63, 66));
        dis.setFont(dis.getFont().deriveFont(dis.getFont().getStyle() | java.awt.Font.BOLD, dis.getFont().getSize()+2));
        dis.setForeground(new java.awt.Color(59, 63, 66));
        dis.setText("089438766645");
        discount.add(dis, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 200, 30));

        jPanel20.setBackground(new java.awt.Color(59, 63, 66));
        jPanel20.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel25.setBackground(new java.awt.Color(171, 172, 173));
        jLabel25.setFont(jLabel25.getFont().deriveFont(jLabel25.getFont().getStyle() | java.awt.Font.BOLD, jLabel25.getFont().getSize()+2));
        jLabel25.setForeground(new java.awt.Color(171, 172, 173));
        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel25.setText("Discount");
        jLabel25.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jLabel25.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanel20.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 30));

        discount.add(jPanel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 30));

        Percentage.setBackground(new java.awt.Color(153, 153, 153));
        Percentage.setForeground(new java.awt.Color(59, 63, 66));
        Percentage.setToolTipText("");
        Percentage.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        per.setBackground(new java.awt.Color(59, 63, 66));
        per.setFont(per.getFont().deriveFont(per.getFont().getStyle() | java.awt.Font.BOLD, per.getFont().getSize()+2));
        per.setForeground(new java.awt.Color(59, 63, 66));
        per.setText("089438766645");
        Percentage.add(per, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 210, 30));

        jPanel19.setBackground(new java.awt.Color(59, 63, 66));
        jPanel19.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel24.setBackground(new java.awt.Color(171, 172, 173));
        jLabel24.setFont(jLabel24.getFont().deriveFont(jLabel24.getFont().getStyle() | java.awt.Font.BOLD, jLabel24.getFont().getSize()+2));
        jLabel24.setForeground(new java.awt.Color(171, 172, 173));
        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel24.setText("Percentage");
        jLabel24.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jLabel24.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanel19.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 30));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(20, 20, 20)
                        .addComponent(Percentage, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public void initiateData(String s) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (rs.getString("type").equals("Valued")) {
                    discount.setVisible(true);
                    dis.setText(rs.getString("discount_type"));
                    if (rs.getString("discount_type").equals("Fixed")) {
                        Percentage.setVisible(true);
                        per.setText(String.valueOf(rs.getFloat("percentage")));
                    } else {
                ...
                ls.add(rs.getString("discount_type"));
