 ...
 * @author Sai
 */
public class PrintLetter extends javax.swing.JFrame {
     ...
     */
    public PrintLetter(Connection conn, JFrame frame, String s) {
        this.conn = conn;
        this.s = s;
        this.ls = ls;
        this.frame = frame;
    ...
    private void initComponents() {
        ...
        Submit2.setText("Print First Remainder");
        ...
        fName2.setText("Please select the letter you want to print");

        Submit3.setText("Print Final Remainder");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(fName2, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 430, 120));
        ...
        jPanel2.add(exit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, -10, -1, 40));
    ...
    private void Submit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Submit2ActionPerformed
        ...
        new CodeSet().firstReaminder(conn, s);
        frame.enable(true);
        this.dispose();
    ...
    private void Submit3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Submit3ActionPerformed
        new CodeSet().finalReaminder(conn, s);
        frame.enable(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintLetter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintLetter(conn, new JFrame(), new String()).setVisible(true);
            }
        });
    }
